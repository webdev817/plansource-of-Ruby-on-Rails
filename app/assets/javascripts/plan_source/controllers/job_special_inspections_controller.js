PlanSource.JobSpecialInspectionsController = PlanSource.JobPlansController.extend({
  ...
  updatePlans: function () {
    ...
    this.set('content', job.getFilteredSpecialInspections(this.get('currentFilter')));
  }.observes(
    'currentFilter',
    'jobController.model',
